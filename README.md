...
软件内可切换音乐来源，并在设置中调整播放音质、列表显示与主题等选项。

若使用过程中遇到广告或引流（如需要加群、关注公众号之类才能使用或升级）的信息，则表明当前运行的软件被人修改过，请注意甄别。

## 项目协议

使用本项目前请阅读以下协议，如有疑问请停止使用。

---

*词语约定：本协议中的“本项目”指本软件；“使用者”指签署本协议的使用者；“官方音乐平台”指对本项目内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。*
...
6.1 本项目完全免费，仅供个人学习交流使用。本项目不对项目内的技术可能存在违反当地法律法规的行为作保证。
