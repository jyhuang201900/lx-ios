  ...
  return (
    <View style={styles.main}>
      ...
      <ScrollView style={styles.content} keyboardShouldPersistTaps={'always'}>
        ...
        <Text selectable style={styles.text} >使用本软件前请阅读以下协议，如有疑问请停止使用。{'\n'}</Text>
        <Text selectable style={styles.text} >词语约定：本协议中的“本项目”指本软件；“使用者”指签署本协议的使用者；“官方音乐平台”指对本项目内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。{'\n'}</Text>
        ...
        <Text selectable style={styles.text} >6.1 本项目完全免费，仅供个人学习交流使用，本项目不对项目内的技术可能存在违反当地法律法规的行为作保证。{'\n'}</Text>
        ...
        <Text selectable style={styles.text} >* 若协议更新，恕不另行通知。</Text>
      </ScrollView>
    </View>
  )
}
